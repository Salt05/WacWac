...
// Controller cho m�n h�nh thi?t l?p cu?c ?ua
public class RaceSetupController : MonoBehaviour
{
    ...
    public GameObject duckPreviewPrefab; // prefab cho 1 con v?t preview (c� Image + Text)
    ...
    private void OnStartPressed()
    {
        ...
        // start race in same scene: notify RaceController ho?c c�c h? th?ng kh�c
